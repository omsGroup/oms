    ...
    methods: {
        ...
        init() {
            ...
            let mat3 = new THREE.ShaderMaterial({
                uniforms: {},
                vertexShader: document.getElementById('vertexShader').textContent===null?'':document.getElementById('vertexShader').textContent,
                fragmentShader: document.getElementById('fragmentShader').textContent===null?'':document.getElementById('fragmentShader').textContent,
                side: THREE.BackSide,
